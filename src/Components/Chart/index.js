...
function Chart() {
    ...
    //state to hold information about user's balance
    const [userBalance, setUserBalance] = useState({})
   //state to hold information about user's transaction history
    ...
    //useEffect that run when this component first render. Get data from BE
    useEffect( ()=>{
            ...
            <Card.Body>
                <Container>
                    ...
                    <div className='img-chart d-flex justify-content-center align-items-center mt-5 mb-4'>
                        ...
                        {
                            /* NOTE: SKETCH
                            If user has transaction history, we will display the cart, but if he/she has no transaction history, we will display message that he/she has no transaction history
                            */
                        }
